...
#'
#' This function generates sample means from a Uniform(a, b) distribution
#' and visualizes the resulting distribution.
#'
#' @param n Sample size per iteration.
#' @param iter Number of iterations (simulations).
#' @param a Lower bound of the uniform distribution (default = 0).
#' @param b Upper bound of the uniform distribution (default = 10).
#' @return A histogram of sample means with an overlaid normal approximation curve.
#' @examples
...
mycltu=function(n,iter,a=0,b=10){
  ...
  curve(dunif(x, a, b), from = a, to = b, add = TRUE, lwd = 4)
